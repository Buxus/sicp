...
(define d (make-mobile (make-branch 3 c) (make-branch 2 c)))
d
((3 ((5 ((2 3) (2 3))) (3 ((2 3) (4 5))))) (2 ((5 ((2 3) (2 3))) (3 ((2 3) (4 5))))))
(total-weight d)
28
...
;; Would need to remove nested (car (cdr x)) calls from selectors
